...
(function(State) {
  State.active = "active";
  State.diagOverride = "diagonal_calc_override";
})(State || (State = {}));
var PaladinAura = (function() {
    ...
    macroArr.forEach(function(macro) {
      ...
      if (macroObj) {
        if (macroObj.get("visibleto") !== "all") {
          ...
          toChat(
            "**Macro '" + macro.name + "' was made visible to all.**",
            true
          );
        }
  ...
  var showConfig = function() {
    ...
    states.forEach(function(s) {
      var acceptableValues = s.acceptables ? s.acceptables : ["true", "false"];
  ...
  var toggleActive = function() {
    ...
    toChat(
      "**Paladin Aura " +
        (getState(State.active) ? "Enabled" : "Disabled") +
        ".**",
